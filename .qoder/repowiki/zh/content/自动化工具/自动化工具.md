...
## 更新摘要
**所做更改**
- 新增AI图像生成功能模块，集成通义万相API实现自动化配图
- 改进重复检测机制，基于URL和中文标题双重检查确保内容唯一性
- 标准化内容块结构，采用Sanity block content格式确保多语言内容一致性
- 增强AI处理流程，支持AI生成配图与内容块结构化输出
- 完善测试工具，新增AI图像生成功能专项测试脚本
...
**更新** 新增AI图像生成功能，集成通义万相API实现自动化配图；改进重复检测机制，基于URL和中文标题双重检查；标准化内容块结构，采用Sanity block content格式确保多语言内容一致性。
